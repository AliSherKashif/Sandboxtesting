...
for(var i=0;i<namearray.length ;i++)
    {
    	 ...
    	 var row = Ti.UI.createTableViewRow({hasChild:true,height:'70px',backgroundColor:'white'});
    	 var l =  Titanium.UI.createLabel({text:namearray[i],left:'21.74%',color:'black'});
    	 row.add(l);
    	 rowdata[i]=row;
    }

// Create the tableView and add it to the window.
			var tableview1 = Titanium.UI.createTableView({data:rowdata,minRowHeight:58});
			Ti.UI.currentWindow.add(tableview1);
